...
This follows the multiview swapchain-registration fix in `docs/codex-multiview-analysis.md`.
...
instead of the session-start pose, giving the same head-locked peek-window behavior as Unity LayeredClient.
