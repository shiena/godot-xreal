...
| [camera-feed-plan.md](plans/camera-feed-plan.md) | implemented 2026-07-13 | XREAL RGB camera → Godot `CameraFeed` (full colour; works alongside 6DoF — SLAM uses the separate grayscale cameras). |
