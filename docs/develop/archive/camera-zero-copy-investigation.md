...
> The RE it proposed was done: `docs/develop/archive/codex-camera-acquire-analysis.md`. The optimisation
> that followed is in `docs/develop/plans/camera-feed-plan.md`. What remains reliable here is the
...
- **Disassembly** (`docs/develop/archive/codex-camera-acquire-analysis.md`): `TryAcquireLatestImage` is a
...
(`ae1d305`, `497117e`, `fcd7a79`, `e7bb8f7`). See `docs/develop/plans/camera-feed-plan.md` for the
