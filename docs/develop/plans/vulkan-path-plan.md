...
full codex document is `docs/develop/archive/codex-vulkan-stage2-design.md`). They agree on the skeleton:
...
`docs/develop/archive/codex-vulkan-stage3-design.md`) independently picked the same primary:
...
4. **Stage 4 - FPV stream: WORKING ON DEVICE (2026-07-31).** Device results, Beam Pro + One Pro:
   ...
   - **Periodic IDR: root cause found (codex RE, `docs/develop/archive/codex-idr-analysis.md`) and a
...
Both designs (ours in the session scratchpad, codex's in
`docs/develop/archive/codex-vulkan-stage4-design.md`) picked the same body: one more stage-2-style
