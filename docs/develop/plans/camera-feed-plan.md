...
- **The SDK calls are free.** `TryAcquireLatestImage` = 4 µs, `DisposeRGBCameraDataHandle` = 5 µs,
  ...
  "the floor is the SDK acquire" conclusion in `docs/develop/archive/camera-zero-copy-investigation.md`;
  every microsecond was on our side. Disassembly: `docs/develop/archive/codex-camera-acquire-analysis.md`.
