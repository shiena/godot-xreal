...
|---|---|---|---|
| 1 | Head rotation (3DoF) | ✅ | **Done** (`XrealHeadTracker`); roll gap **solved** — the tracker now uses the display pose (full attitude), see `docs/develop/archive/roll-tracking-investigation.md` |
...
| 7 | Hand tracking | ❌ (no camera) | **implemented for the Air 2 Ultra** (`docs/develop/plans/hand-tracking-plan.md`); gated off on One Pro via `IsHandTrackingSupported()` |
...
DISP pose (`docs/develop/archive/codex-headlock-analysis.md`).
