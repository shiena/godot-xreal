#!/usr/bin/env pwsh
# Regenerate the GDScript API documentation from its single source of truth, the `///` doc
...
# produces the bytes, so this twin needs no output-parity dance. It needs a host Rust toolchain.
#
